...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-emerald-100 shadow-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div>
              <span className="text-xl sm:text-2xl font-bold text-gray-900 tracking-tight flex items-center gap-1.5">
                Care Companion
          ...
          <nav className="hidden md:flex items-center gap-6">
            <Link
              href="/companions"
              className="text-sm font-semibold text-gray-700 hover:text-emerald-700 transition flex items-center gap-1.5"
            >
          ...
          <div className="hidden md:flex items-center gap-3">
            {loading ? (
              <div className="w-32 h-10 bg-gray-100 animate-pulse rounded-xl" />
            ) : profile ? (
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-emerald-700 text-white font-bold text-xs hover:bg-emerald-800 shadow-md shadow-emerald-200 transition active:scale-95 cursor-pointer"
              >
      ...
      {/* Mobile Drawer */}
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-gray-100 bg-white px-4 py-5 space-y-3">
          <Link
            href="/companions"
